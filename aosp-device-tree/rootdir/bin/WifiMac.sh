...
setprop vendor.wifi.version.driver WLAN.HMT.1.0-03851-QCAHMTSWPL_V1.0_V2.0_SILICONZ-1.33063.3.37453.2
#setprop wigig.version.driver 5.3.0.72
#setprop wigig.dock.version.driver v0.0.0.10

# BT
setprop vendor.bt.version.driver BTFW.HAMILTON.2.0.0-00516-PATCHZ-1.33576.2.36277.3
